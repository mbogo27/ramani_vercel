...
It encodes brand logic, clinical rules, voice constrains, and behavioral protocols for Ai agents operating across patient-facing channels. 
...
emergency_override: true # HE-emergency-pain-response 
...
2. If emotional signals detected → activate HE-emotional escalation before anything else  
